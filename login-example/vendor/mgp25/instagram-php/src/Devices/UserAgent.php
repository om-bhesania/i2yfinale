...
class UserAgent
{
        ...
        DeviceInterface $device)
    {
        if ($device->getPlatform() === 'ios') {
            list($width, $height) = explode('x', Constants::IOS_DPI);
            $density = Constants::IOS_SCALE;
            $result = [
                'FBAN' => $appName,
                'FBAV' => Constants::IG_IOS_VERSION,
                'FBBV' => Constants::IG_IOS_VERSION_CODE,
                ...
                'FBDV' => Constants::IOS_MODEL,
                'FBSV' => Constants::IOS_VERSION,
                'FBMD' => 'iPhone',
                'FBSN' => 'iOS',
                'FBID' => 'phone',
                'FBOP' => 5
