...
class StorageHandler
{
    ...
    const PERSISTENT_KEYS = [
        ...
        'last_login_web', // Tracks time elapsed since our last web login state refresh.
        ...
        'query_hash_gtf', // query_hash for getTimelineGraph() function.
        ...
        'ds_user_id',
        'rur',
        'is_custom_device', // true or false
    ];
