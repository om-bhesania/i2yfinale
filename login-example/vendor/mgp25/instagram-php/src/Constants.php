...
class Constants
{
    ...
    const API_URLS = [
        ...
        6 => 'https://i.instagram.com/',
        8 => 'https://b.i.instagram.com/api/v1/',
    ];
    const GRAPH_API_URL = 'https://graph.instagram.com/logging_client_events';

    const IG_VERSION = '236.0.0.20.109';
    const VERSION_CODE = '371679880';
    ...
    // Endpoint Constants.
    const BLOCK_VERSIONING_ID = '8d23623552837d8fc21d0fc788d87657311dc2eabfc2c05f51b1297496c73aef'; // x-bloks-version-id	
    ...
    const SUPPORTED_CAPABILITIES = [
        [
            ...
            'value' => '119.0,120.0,121.0,122.0,123.0,124.0,125.0,126.0,127.0,128.0,129.0,130.0,131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0',
        ],
        [
            'name'  => 'segmentation',
    ...
    const GRAPH_API_ACCESS_TOKEN_IOS = '84a456d620314b6e92a16d8ff1c792dc';
    ...
    const ANALYTICS_ACCESS_TOKEN_IOS = '124024574287414|84a456d620314b6e92a16d8ff1c792dc';
    ...
    // iOS API constants
    // Instagram 240.1.0.26.107 (iPhone13,3; iOS 15_0_1; en_US; en-US; scale=3.00; 1170x2532; 378200232)
    const IG_IOS_VERSION      = '240.1.0.26.107';
    const IOS_VERSION         = '15_0_1';
    const IOS_MODEL           = 'iPhone13,3';
    const IOS_DPI             = '1170x2532';
    const IOS_SCALE           = '3.00';
    const IG_IOS_VERSION_CODE = '378200232';
    const SIG_KEY_IOS_VERSION = '5';
    const IOS_IG_SIG_KEY      = 'SIGNATURE';
    const IOS_BLOCKS_VERSIONING_ID = '2c9f54ff6976281c3dc33597e1c8aa3018894eca91eef4e25b1343166729a6b3';
    const IOS_X_IG_Capabilities = '36r/F/8=';
    const IOS_SUPPORTED_CAPABILITIES = [
        [
            'name'  => 'segmentation',
            'value' => 'segmentation_enabled'
        ],
        ...
        [
            ...
            'value' => 'REAL_SCALE_ESTIMATION_ENABLED'
        ],
        [
            'name'  => 'SUPPORTED_SDK_VERSIONS',
            'value' => '119.0,120.0,121.0,122.0,123.0,124.0,125.0,126.0,127.0,128.0,129.0,130.0,131.0,132.0,133.0,134.0,135.0,136.0,137.0,138.0,139.0,140.0,141.0'
        ],
        [
            'name'  => 'COMPRESSION',
            'value' => 'PVR_COMPRESSIO'
        ],
        [
            'name'  => 'FACE_TRACKER_VERSION',
            'value' => '14'
