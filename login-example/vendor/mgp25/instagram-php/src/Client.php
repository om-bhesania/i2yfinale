...
class Client
{
        ...
        array $guzzleOptions = [])
    {
        ...
        do {
            ...
            // By default maximum connection retries is 5.
            try {
        ...
        array $guzzleOptions = [])
    {
        ...
        if (!$this->_parent->isWebLogin) {
            ...
            if (!empty($this->_navChain)) {
                ...
                //     $this->ig->setNavChainHeader('1nD:feed_timeline:20', true);
                // } else {
                //     $this->ig->setNavChainHeader('IGMainAppViewController:feed_timeline:1', true);
                // }
            }
            if ($this->_parent->getIsAndroid()) {
                $headers['set_headers']['X-IG-SALT-IDS'] = (string) mt_rand(1061162222, 1061262222);
            }
        }
